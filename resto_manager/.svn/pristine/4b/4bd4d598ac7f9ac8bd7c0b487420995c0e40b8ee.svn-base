(function() {
  ...
  */
  ...
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.nextButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Suivant →</button>';

    Base.prototype.finalButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Terminer</button>';
