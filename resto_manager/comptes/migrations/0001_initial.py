...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comptes_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='user_profile', unique=True, null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'comptes', ['UserProfile'])

        # Adding model 'Restaurateur'
        db.create_table(u'comptes_restaurateur', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='restaurateur', unique=True, null=True, to=orm['auth.User'])),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal(u'comptes', ['Restaurateur'])
