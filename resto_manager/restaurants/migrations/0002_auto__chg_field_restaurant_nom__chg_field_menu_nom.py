...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Restaurant.nom'
        db.alter_column(u'restaurants_restaurant', 'nom', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Menu.nom'
        db.alter_column(u'restaurants_menu', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Restaurant.nom'
        db.alter_column(u'restaurants_restaurant', 'nom', self.gf('django.db.models.fields.CharField')(default='nom', max_length=30))

        # Changing field 'Menu.nom'
        db.alter_column(u'restaurants_menu', 'nom', self.gf('django.db.models.fields.CharField')(default='nom', max_length=50))
