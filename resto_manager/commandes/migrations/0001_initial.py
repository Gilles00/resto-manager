...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'commandes_commande', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commandes', to=orm['comptes.UserProfile'])),
            ('restaurant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commandes', to=orm['restaurants.Restaurant'])),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'commandes', ['Commande'])

        # Adding model 'LigneCommande'
        db.create_table(u'commandes_lignecommande', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('commande', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ligne_commandes', to=orm['commandes.Commande'])),
            ('repas', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ligne_commandes', to=orm['restaurants.Repas'])),
            ('prix', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'commandes', ['LigneCommande'])


    def backwards(self, orm):
        # Deleting model 'Commande'
        db.delete_table(u'commandes_commande')

        # Deleting model 'LigneCommande'
        db.delete_table(u'commandes_lignecommande')
