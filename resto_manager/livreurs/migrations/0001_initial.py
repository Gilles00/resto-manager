...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Livreur'
        db.create_table(u'livreurs_livreur', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='livreur', unique=True, null=True, to=orm['auth.User'])),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal(u'livreurs', ['Livreur'])


    def backwards(self, orm):
        # Deleting model 'Livreur'
        db.delete_table(u'livreurs_livreur')
